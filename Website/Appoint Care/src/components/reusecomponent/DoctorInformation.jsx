                                ...
                                <div className="card-body-2">
                                    <div className="container">
                                        <div class="row doctor-subtitle">
                                            ...
                                            <div className="col-2"></div>
                                            <div className="col-2">
                                                <h4><i class="fa-solid fa-check right"></i> Accepting New Patients</h4>
                                            </div>
                                            <div className="col-8"></div>
                                            <div className="col-2"></div>
                                            <div className="col-2">
                                                <h4><i class="fa-solid fa-video right"></i> Virtual Visit Available</h4>
                                            </div>
                                            <div className="col-8"></div>
                                            <div className="col-2"></div>
                                            <div className="col-2">
                                                <h4><i class="fa-solid fa-location-dot right"></i> San Fabian, Pangasinan</h4>
                                            </div>
                                            <div className="col-8"></div>
                                            <div className="col-2"></div>
                                            <div className="col-2">
